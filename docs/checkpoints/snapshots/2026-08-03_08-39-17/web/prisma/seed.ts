...
async function main() {
  ...
  // Seed remaining roles
  const rolesToSeed = [
    { role: Role.MD, email: "md@mrtracker.com", password: "md12345", first: "Managing", last: "Director" },
    { role: Role.NSM, email: "nsm@mrtracker.com", password: "nsm12345", first: "National", last: "Manager" },
    { role: Role.ZSM, email: "zsm@mrtracker.com", password: "zsm12345", first: "Zonal", last: "Manager" },
    { role: Role.RM, email: "rm@mrtracker.com", password: "rm12345", first: "Regional", last: "Manager" },
    { role: Role.HR, email: "hr@mrtracker.com", password: "hr12345", first: "HR", last: "Representative" },
    { role: Role.FINANCE, email: "finance@mrtracker.com", password: "finance12345", first: "Finance", last: "Officer" },
    { role: Role.WAREHOUSE, email: "warehouse@mrtracker.com", password: "warehouse12345", first: "Warehouse", last: "Manager" },
    { role: Role.MARKETING, email: "marketing@mrtracker.com", password: "marketing12345", first: "Marketing", last: "Lead" },
    { role: Role.DOCTOR, email: "doctor@mrtracker.com", password: "doctor12345", first: "Doctor", last: "User" },
    { role: Role.DISTRIBUTOR, email: "distributor@mrtracker.com", password: "distributor12345", first: "Distributor", last: "User" }
  ];
  ...
  for (const item of rolesToSeed) {
    ...
    if (item.role !== Role.DOCTOR && item.role !== Role.DISTRIBUTOR) {
    ...
    console.log(`✅ Seeded role user: ${item.email} (${item.role})`);
  }
  ...
  console.log("  NSM         → email: nsm@mrtracker.com         | password: nsm12345");
  console.log("  ZSM         → email: zsm@mrtracker.com         | password: zsm12345");
  console.log("  RM          → email: rm@mrtracker.com          | password: rm12345");
  console.log("  HR          → email: hr@mrtracker.com          | password: hr12345");
  console.log("  Finance     → email: finance@mrtracker.com     | password: finance12345");
  console.log("  Warehouse   → email: warehouse@mrtracker.com   | password: warehouse12345");
  console.log("  Marketing   → email: marketing@mrtracker.com   | password: marketing12345");
  console.log("  Doctor      → email: doctor@mrtracker.com      | password: doctor12345");
  console.log("  Distributor → email: distributor@mrtracker.com  | password: distributor12345");
}
