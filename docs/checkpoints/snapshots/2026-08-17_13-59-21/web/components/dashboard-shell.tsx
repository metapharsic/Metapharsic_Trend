...
const NAV_ITEMS = [
  ...
  { href: "/mr/claims", label: "My Claims", icon: AlertTriangle, roles: ["MR", "ADMIN"], category: "Field Force" },
  ...
  { href: "/admin/claims", label: "Claims Review", icon: AlertTriangle, roles: ["ADMIN", "ASM"], category: "Field Force" },
  ...
  { href: "/finance/accounts", label: "Chart of Accounts", icon: IndianRupee, roles: ["FINANCE", "ADMIN", "MD"], category: "Finance & HR" },
  { href: "/finance/journal", label: "Journal Entries", icon: IndianRupee, roles: ["FINANCE", "ADMIN"], category: "Finance & HR" },
  { href: "/finance/reports", label: "Finance Reports", icon: IndianRupee, roles: ["FINANCE", "ADMIN", "MD"], category: "Finance & HR" },
