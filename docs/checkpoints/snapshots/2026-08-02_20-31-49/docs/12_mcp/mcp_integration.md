...
The AI assistant integrates standard servers:
- **GitNexus**: Enables commit tracking, diff reviewing, and automated PR change analysis.
- **CodeGraph**: Exposes symbols index lookups (`codegraph_search`, `codegraph_callers`, `codegraph_callees`) to traverse the monorepo codebase.
