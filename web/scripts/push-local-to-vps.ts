...
async function runMultiAgentVpsPush() {
  ...
  const filesToTransfer = [
    ...
    { local: "app/api/system/config/route.ts", remote: "app/api/system/config/route.ts" },
    { local: "app/api/system/update/fetch/route.ts", remote: "app/api/system/update/fetch/route.ts" },
    { local: "app/api/system/update/pull/route.ts", remote: "app/api/system/update/pull/route.ts" },
    { local: "app/api/system/update/fetch-commit/route.ts", remote: "app/api/system/update/fetch-commit/route.ts" },
    { local: "app/api/system/update/apply-commit/route.ts", remote: "app/api/system/update/apply-commit/route.ts" },
    ...
    { local: "services/system-config.service.ts", remote: "services/system-config.service.ts" },
    { local: "jobs/github-sync.ts", remote: "jobs/github-sync.ts" },
    { local: "instrumentation.ts", remote: "instrumentation.ts" },
